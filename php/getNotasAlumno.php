<?php
	...
	function getNotas() {
		global $mysqli, $clase, $usuario, $examen, $order, $pagina, $maxResults;
		...
		if(isset($clase)){
		    $qArray1[] = 'marcadores.clase = ?';
		    $bindParam->add('i', intval($clase));
		}
		if(isset($examen)){
		...
		$stmt->execute();
		$stmt->bind_result($res_id_nota, $res_fecha, $res_examen, $res_marcador, $res_clase, $res_totalRegistros);
